...
# extract xyz
# load aligned trajs
#open_state_1 = md.load("../trajs/p53.1.pdb", "../trajs/p53.1.dcd")
#open_state_2 = md.load("../trajs/p53.2.pdb", "../trajs/p53.2.dcd")

open_state_1 = md.load("../trajs/4ake-01-align.dcd", top="../trajs/p53.1.pdb")
open_state_2 = md.load("../trajs/4ake-02-align.dcd", top="../trajs/p53.2.pdb")
